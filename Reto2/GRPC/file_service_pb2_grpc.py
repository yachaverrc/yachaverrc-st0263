...
class FileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FileExists = channel.unary_unary(
                '/file_service.FileService/FileExists',
                request_serializer=file__service__pb2.FileExistsRequest.SerializeToString,
                response_deserializer=file__service__pb2.FileExistsResponse.FromString,
                )
...
def add_FileServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FileExists': grpc.unary_unary_rpc_method_handler(
                    servicer.FileExists,
                    request_deserializer=file__service__pb2.FileExistsRequest.FromString,
                    response_serializer=file__service__pb2.FileExistsResponse.SerializeToString,
            ),
    }
...
class FileService(object):
    ...
    def FileExists(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/file_service.FileService/FileExists',
            file__service__pb2.FileExistsRequest.SerializeToString,
            file__service__pb2.FileExistsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
